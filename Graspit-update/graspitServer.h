...
/*!
  ...
  comments: added 4 new commands, none of them require any parameters
  - \p autoGrasp 
  - \p autoOpen
  - \p loadObject
  - \p removeObject
  loadObject imports the object from file obj.wrl (object should be in
  VRML format)
  ----------END MODIFIED-----------------------------------------
...
private:
  ...
  //--------------------MODIFIED------------------------
  // author: gokererdogan@gmail.com
  // signatures for added commands
  void autoGrasp();
  void autoOpen();
  void loadObject();
  void removeObject();
  void rotateObject();
  void aomrGetJointAngles();
  //---------------END MODIFIED------------------------
